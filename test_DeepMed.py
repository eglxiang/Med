...
inputParamsConfigLocal['learning_rate'] = '0.036'
inputParamsConfigLocal['momentum'] = '0.9'
inputParamsConfigLocal['num_epochs'] = '40'
...
inputParamsConfigLocal['numberOfFCUnits'] = 1200 #number of units in first fully connected layer; originally 64
inputParamsConfigLocal['numberOfFCLayers'] = 3 #number of FC layers (including the softmax layer)
...
inputParamsConfigLocal['phase'] = 'discrim'#'screen' or 'discrim'; changes way train set is built
