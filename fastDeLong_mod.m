...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Difference between this and original fastDelong is that this function does
%not calculate the covariance matrix or standard deviation of AUC; reason
%for creating this was for data files with millions of scores for which the
%calculation of the covariance matrix was practically impossible due to
%large size;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [AUC,S] = fastDeLong_mod(X,Y)
...
AUC = mean(V01)';
S = 0; %this was put in so that covariance matrix wouldn't be computed for massive matrices; otherwise next line should be uncommented
